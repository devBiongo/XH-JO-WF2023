...
import com.jo.common.constant.UserConstants;
...
import com.jo.common.exception.user.*;
...
public class SysLoginService {
    ...
    public String login(String username, String password, String code, String uuid) {
        ...
        Map<String, Object> claims = new HashMap<>() {{
            put("userId", loginUser.getUser().getUserId());
            put("username", loginUser.getUser().getUsername());
        }};
